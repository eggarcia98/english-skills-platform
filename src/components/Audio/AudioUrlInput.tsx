    ...
    return (
        <div className="flex flex-col gap-3 items-center w-full h-fit">
            ...
            <div className="flex gap-2 w-full justify-center">
                <input
                    className="peer h-full w-full sm:w-full md:w-96 lg:w-98  rounded-[7px] border border-blue-gray-200 bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-teal-500  focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
